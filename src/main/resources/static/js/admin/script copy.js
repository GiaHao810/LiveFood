...
function addQuantity(labelValue){
    ...
    inputElements.forEach(function(inputElement){
        var row = inputElement.closest('.row');
...
function addNewRowItem(labelValue, itemPrice, imageURL){
    ...
    newRow.innerHTML = `
            ...
            <div class="col">
                <input class="col-md order-quantity border border-3 rounded h-100" type="number" value="1">
            </div>
            <div class="col">
...
function a(){
    var productList = document.querySelectorAll('#ordertable li');
